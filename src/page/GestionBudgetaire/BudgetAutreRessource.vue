<template>
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h3 style="font-size: 16px">Liste Budget Autres Ressource</h3>
      <!-- <nav>
        <ol class="breadcrumb">
...
<section class="section dashboard">
    <table class="table table-bordered border-primary">
        ...
        <tbody>
          <tr v-for="item1 in getterDotationAutreRessource" :key="item1.id">
            ...
            <td>
              ...
              <span
                ...
                style="cursor: pointer"
                @click.prevent="supprimerDotationAutreRessource(item1.id)"
                >Supprimer</span
              >
            </td>
          </tr>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Ajouter Budget Autres Ressource</h5>
            <button
              type="button"
              class="btn-close"
    ...
    <div class="modal fade" id="largeModal1" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Modifier Buddget Autres Ressource</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
          ...
          <div class="modal-footer">
            <button
              ...
              class="btn btn-secondary"
              data-bs-dismiss="modal"
              @click.prevent="this.getDotationAutreRessource()"
            >
              Fermer
            </button>
            <button
...
export default {
  ...
  created() {
    ...
    // this.getGroupeActivitebudgetAutreRessource()
    this.getDotationAutreRessource();
  },
  computed: {
    ...mapGetters("parametrage", [
      "getterActivite",
      "getterExerciceBudgetaire","getterDotationAutreRessource",'getterGrpeActiviteBudgetAutreRessource'
    ]),
     
 listeBudgetNotifie() {
      return (id) => {
        if (id != null && id != "") {
          return this.getterDotationAutreRessource.filter(
  ...
  methods: {
    ...mapActions("parametrage", ["getActivite", "getExerciceBudgetaire","getDotationAutreRessource",
      "ajouterDotationAutreRessource",
      "modifierDotationAutreRessource",
      "supprimerDotationAutreRessource",'getGroupeActivitebudgetAutreRessource']),
    
    AfficheModalModification(id) {
      this.modNatureDepense = this.getterDotationAutreRessource.find(
        (items) => items.id == id
      );
    },
    EnregistrerSection() {
      ...
      this.ajouterDotationAutreRessource(objetDirect1);
    ...
    modificationSection() {
      ...
      this.modifierDotationAutreRessource(objetDirect1);
